...
export const Policy=({rules, securityAndHealth, cancellation})=>{
    const textSplitter = (string) => {
        ...
        <PolicyWrapper>
            ...
            <Policies>
                <div>
                    <h3>Reglas</h3>
                    <ul>
                        {textSplitter(rules).map((item, index) => {
                ...
                <div>
                    ...
                    <ul>
                        {textSplitter(securityAndHealth).map((item, index) => {
                            return <li key={index+item}>{item}</li>
                        })}
                    </ul>
                </div>
                <div>
                    <h3>Cancelacion</h3>
                    <ul>
                        {textSplitter(cancellation).map((item, index) => {
                            return <li key={index+item}>{item}</li>
                        })}
                    </ul>
                </div>
