...
const initialState = {
    urlProducts : "http://localhost:8081/products",
    city: "",
    category: "",    
    categoryBox: [],
    selectedDays: {
...
const dataReducer=(state, action,)=>{
    switch (action.type) {
        ...
        case types.productsCity:
            return{  
                ...state,                             
                urlProducts: "​http://localhost:8081/products/searchCity?city=",
                city: action.payload,
                category: "",                 
                categoryBox: [],                 
            }
        ...
        case types.productsCategory:
            return{
                ...state,
                urlProducts: "​​http://localhost:8081/products/searchCategory?category=",
                city: "",
        ...
        case types.searchByDates:
            return{
                ...state,
                urlProducts : `​​http://localhost:8081/products/searchDates`,
